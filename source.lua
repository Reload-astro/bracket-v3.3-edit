...
local MainAssetFolder = IsLocal and ReplicatedStorage.LibraryGui or InsertService:LoadLocalAsset("rbxassetid://109908609158623")
...
function Assets:Screen()
	local ScreenAsset = GetAsset("Screen/Library")
	if not IsLocal then sethiddenproperty(ScreenAsset,"OnTopOfCoreBlur",true) end
	ScreenAsset.Name = "Library " .. game:GetService("HttpService"):GenerateGUID(false)
...
function Assets.Snowflakes(WindowAsset)
	local ParticleEmitter = loadstring(game:HttpGet("https://raw.githubusercontent.com/Reload-astro/bracket-v3.3-edit/refs/heads/main/snowflakes.lua"))()
...
function Library:Window(Window)
	...
	local WindowAsset = Assets:Window(Library.ScreenAsset,Window)

	function Window:Tab(Tab)
		Tab = GetType(Tab,{},"table",true)
		Tab.Name = GetType(Tab.Name,"Tab","string")
		local TabAsset = Assets:Tab(Library.ScreenAsset,WindowAsset,Window,Tab)
		...
		function Tab:Button(Button)
			...
			Assets:Button(ChooseTabSide(TabAsset,Button.Side),Library.ScreenAsset,Window,Button)
			return Button
		end
		function Tab:Toggle(Toggle)
			...
			local ToggleAsset = Assets:Toggle(ChooseTabSide(TabAsset,Toggle.Side),Library.ScreenAsset,Window,Toggle)
			function Toggle:Keybind(Keybind)
				...
				Assets:ToggleKeybind(ToggleAsset.Layout,Library.ScreenAsset,Window,Keybind,Toggle)
				return Keybind
			end
			function Toggle:Colorpicker(Colorpicker)
				...
				Assets:ToggleColorpicker(ToggleAsset.Layout,Library.ScreenAsset,Window,Colorpicker)
				return Colorpicker
			end
			return Toggle
		end
		function Tab:Slider(Slider)
			...
			Assets:Slider(ChooseTabSide(TabAsset,Slider.Side),Library.ScreenAsset,Window,Slider)
			return Slider
		end
		function Tab:Textbox(Textbox)
			...
			Assets:Textbox(ChooseTabSide(TabAsset,Textbox.Side),Library.ScreenAsset,Window,Textbox)
			return Textbox
		end
		function Tab:Keybind(Keybind)
			...
			Assets:Keybind(ChooseTabSide(TabAsset,Keybind.Side),Library.ScreenAsset,Window,Keybind)
			return Keybind
		end
		function Tab:Dropdown(Dropdown)
			...
			Assets:Dropdown(ChooseTabSide(TabAsset,Dropdown.Side),Library.ScreenAsset,Window,Dropdown)
			return Dropdown
		end
		function Tab:Colorpicker(Colorpicker)
			...
			Assets:Colorpicker(ChooseTabSide(TabAsset,Colorpicker.Side),Library.ScreenAsset,Window,Colorpicker)
			return Colorpicker
		end
		function Tab:Section(Section)
			...
			function Section:Button(Button)
				...
				Button.Name = GetType(Button.Name,"Button","string")
				Button.Callback = GetType(Button.Callback,function() end,"function")
				Assets:Button(SectionContainer,Library.ScreenAsset,Window,Button)
				return Button
			end
			function Section:Toggle(Toggle)
				...
				local ToggleAsset = Assets:Toggle(SectionContainer,Library.ScreenAsset,Window,Toggle)
				function Toggle:Keybind(Keybind)
					Keybind = GetType(Keybind,{},"table",true)
					Keybind.Flag = GetType(Keybind.Flag,Toggle.Flag .. "/Keybind","string")
			...
			function Section:Slider(Slider)
				...
				Assets:Slider(SectionContainer,Library.ScreenAsset,Window,Slider)
				return Slider
			end
			function Section:Textbox(Textbox)
				...
				Assets:Textbox(SectionContainer,Library.ScreenAsset,Window,Textbox)
				return Textbox
			end
			function Section:Keybind(Keybind)
				...
				Assets:Keybind(SectionContainer,Library.ScreenAsset,Window,Keybind)
				return Keybind
			end
			function Section:Dropdown(Dropdown)
				...
				Assets:Dropdown(SectionContainer,Library.ScreenAsset,Window,Dropdown)
				return Dropdown
			end
			function Section:Colorpicker(Colorpicker)
				...
				Assets:Colorpicker(SectionContainer,Library.ScreenAsset,Window,Colorpicker)
				return Colorpicker
			end
			return Section
		end
...
function Library:Notification(Notification)
	...
	NotificationAsset.Parent = Library.ScreenAsset.NDHandle
...
function Library:Notification2(Notification)
	Notification = GetType(Notification,{},"table")
	Notification.Title = GetType(Notification.Title,"Title","string")
	...
	NotificationAsset.Parent = Library.ScreenAsset.NLHandle
